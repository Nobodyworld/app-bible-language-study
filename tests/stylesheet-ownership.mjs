...
console.log(JSON.stringify({status:"ok", files:inventory.files, rules:inventory.ruleCount, important:inventory.importantCount, crossFileSelectors:inventory.overlapCount, negativeControls:7}, null, 2));
