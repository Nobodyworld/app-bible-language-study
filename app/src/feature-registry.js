...
export const FEATURE_REGISTRY = Object.freeze([
  ...
  descriptor({
    ...
    description: "Technical package capability toggles for isolated Lab diagnostics.",
    lifecycle: "frozen",
    defaultProfiles: ["lab"],
    dependencies: ["my-data"],
    ...
    testOwners: ["tests/capabilities.mjs", "app/scripts/package-state-test.mjs", "app/scripts/feature-profile-interaction-test.mjs"],
  }),
  descriptor({
